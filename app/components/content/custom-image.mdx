...
<Alert><AlertTitle>Warning</AlertTitle><AlertDescription>You should have my other component, [modal](/components/ui-0) installed before installing this component.</AlertDescription></Alert>
