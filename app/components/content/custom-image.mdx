...
<TabsList>  <TabsTrigger value="preview">Preview</TabsTrigger>
          ...
          <TabsContent value="preview">
                <Viewport reloadButton >
   <CImage width={300} height={300} loadingIndicator pause  src="/example.jpg" />
</Viewport>    </TabsContent> <TabsContent value="code">
   ```tsx showLineNumbers  
import CImage from "./c-image";
...
<TabsList>  <TabsTrigger value="preview">Preview</TabsTrigger>
          ...
          <TabsContent value="preview">
                <Viewport reloadButton >
   <CImage  hide width={300} height={300} loadingIndicator src="/example.jpg" />
</Viewport>    </TabsContent> <TabsContent value="code">
   ```tsx showLineNumbers  
import CImage from "./c-image";
...
const ImageExample = () => {
    return (
        <CImage skeleton={false}  width={300} height={300} delay={2500}  src="/example.jpg" />
    )
}
...
<TabsList>  <TabsTrigger value="preview">Preview</TabsTrigger>
          ...
          <TabsContent value="preview">
                <Viewport reloadButton >
   <CImage dropdown width={300} height={300} delay={2500} src="/example.jpg" >Colin Guinane</CImage>
</Viewport>    </TabsContent> <TabsContent value="code">
   ```tsx showLineNumbers  
import CImage from "./c-image";
